...
****************/ 
mysql_connect('localhost', 'alex', 'password') or trigger_error("Unable to connect to the database: " . mysql_error()); 
mysql_select_db('quiz_db') or trigger_error("Unable to switch to the database: " . mysql_error()); 
...
require_once($_SERVER['DOCUMENT_ROOT'] . $sFolder . '/functions.php'); 
